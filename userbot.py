...
app = Client("my_account", api_id=19721424, api_hash="5b44f07acb6d83507934fa84463dedd5")
...
spam_posts = [TextPost("Дала 1алаш Дойла шу Дала т1аьхьи беркате йойла", delay=20)]
# App - stores Pyrogram instance
app = Client("my_account", config_file="config.ini", workers=1)
